...
const Hamburger = (props: Props): React.ReactNode => {
    return (
        <button
            type='button'
            className='inline-flex items-center p-2 text-sm text-txt-medium rounded-lg sm:hidden hover:bg-high focus:outline-none focus:ring-2 focus:ring-txt-high dark:text-txt-medium dark:hover:bg-high dark:focus:ring-txt-high'>
